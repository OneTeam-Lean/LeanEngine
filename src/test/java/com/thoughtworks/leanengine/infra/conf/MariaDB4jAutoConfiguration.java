...
public class MariaDB4jAutoConfiguration {
  ...
  public MariaDB4jSpringService mariaDB4jSpringService() {
    ...
    String dataDir =
        StringUtils.isEmpty(mariaDB4jProperties.getDataDir())
            ? dBConfigurationBuilder.getDataDir()
            : mariaDB4jProperties.getDataDir();
    String libDir =
        StringUtils.isEmpty(mariaDB4jProperties.getLibDir())
            ? dBConfigurationBuilder.getLibDir()
            : mariaDB4jProperties.getLibDir();
    String socket =
        StringUtils.isEmpty(mariaDB4jProperties.getSocket())
            ? dBConfigurationBuilder.getSocket()
            : mariaDB4jProperties.getSocket();
    String baseDir =
        StringUtils.isEmpty(mariaDB4jProperties.getBaseDir())
            ? dBConfigurationBuilder.getBaseDir()
            : mariaDB4jProperties.getBaseDir();
  ...
  public DataSource dataSource(
      DataSourceProperties dataSourceProperties, MariaDB4jSpringService mariaDB4jSpringService)
